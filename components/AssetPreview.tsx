...
const AssetPreview: React.FC<Props> = ({ assets, thumbnailText, onSelectThumbnail, isShorts = false }) => {
  ...
  return (
    <div className="bg-gray-800 rounded-lg p-4 shadow-lg border border-gray-700 h-full flex flex-col">
      ...
      <div className={`
        flex-1 bg-black rounded-lg overflow-hidden relative group border border-gray-700 mx-auto transition-all duration-500 flex items-center justify-center
        ${isShorts ? 'w-full max-w-[340px] aspect-[9/16]' : 'w-full aspect-video'}
      `}>
        {activeTab === 'thumbnail' ? (
           renderThumbnailGrid()
        ) : (
